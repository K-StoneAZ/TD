...
void ResizeBackBuffer(HWND hwnd)
{
    ...
    g_backBitmap = CreateCompatibleBitmap(hdc, clientW, clientH);
    g_backOldBmp = (HBITMAP)SelectObject(g_backDC, g_backBitmap);
    ReleaseDC(hwnd, hdc);
...
void SelectWave()
{
    ...
    if (w_count > 3 && g_pathIndex >= 9) {
        ...
        g_waves = 5 + rand() % (temp); // floating repeats
    }
...
void UpdateWave(float deltaTime)
{
	...
	static int waveCount = g_waves; // local counter for repetitions of current wave
    if (waveCount == 0)
    {
...
void InitializeTower(Tower& t)
{
    ...
    static const TowerDef defs[] =
    {
        ...
        { 0, 0, 100.f,  80.f,  0.f,  0.f,  80,  10.0f,  0.0f,   0.1f, Gdiplus::Color(255,120,200,255), L"siphon0.png" }, // case 0
        { 1, 0,   0.f,   0.f,  0.f,  0.f, 300,  15.0f,  0.0f,   0.0f,  Gdiplus::Color(255,160,160,200), L"barrier0.png" }, // case 1
        { 2, 0, 100.f,   0.f, 1.5f,  1.f, 120,  20.0f,  3.0f,   1.5f,  Gdiplus::Color(255,255,80,80),   L"attack0.png"   }, // case 2
        { 0, 1, 120.f, 120.f,  0.f,  0.f, 120,  20.0f,  0.0f,   0.25f, Gdiplus::Color(255,100,200,255), L"siphon1.png"   }, // case 3
        { 1, 1,   0.f,   0.f,  0.f,  0.f, 600,  30.0f,  0.0f,   0.0f,  Gdiplus::Color(255,160,140,220), L"barrier1.png"  }, // case 4
        { 2, 1, 120.f,   0.f,  2.f,  3.f, 150,  30.0f,  6.0f,   2.0f,  Gdiplus::Color(255,255,80,100),  L"attack1.png"   }, // case 5
        { 0, 2, 160.f, 160.f,  0.f,  0.f, 160,  30.0f,  0.0f,   0.5f,  Gdiplus::Color(255,80,200,255),  L"siphon2.png"   }, // case 6
        { 1, 2,   0.f,   0.f,  0.f,  0.f, 900,  40.0f,  0.0f,   0.0f,  Gdiplus::Color(255,160,140,220), L"barrier2.png"  }, // case 7
        { 2, 2, 140.f,   0.f,  4.f,  4.f, 200,  50.0f,  8.0f,   4.0f,  Gdiplus::Color(255,255,80,120),  L"attack2.png"   }  // case 8
    };
...
// --- Copy back buffer directly to screen (no scaling) ---
    BitBlt(
        hdc,
        0, 0,
        g_backW, g_backH,
...
// --- Get monitor resolution ---
	...
	float scaleX = (float)monitorW / SCREEN_W; g_scaleX = scaleX;
	float scaleY = (float)monitorH / SCREEN_H; g_scaleY = scaleY;
	float scale = std::min(scaleX, scaleY); g_scale = scale;
